...
// local
#include "RawBankToFilteredSTLiteClusterAlg.h"
...
//-----------------------------------------------------------------------------
// Implementation file for class : RawBankToFilteredSTLiteClusterAlg
//
// 2015-05-06 : Elena Graverini
//-----------------------------------------------------------------------------

DECLARE_ALGORITHM_FACTORY( RawBankToFilteredSTLiteClusterAlg )

RawBankToFilteredSTLiteClusterAlg::RawBankToFilteredSTLiteClusterAlg( const std::string& name,
...
RawBankToFilteredSTLiteClusterAlg::~RawBankToFilteredSTLiteClusterAlg() {
  // Destructor
}

StatusCode RawBankToFilteredSTLiteClusterAlg::initialize() {
...
StatusCode RawBankToFilteredSTLiteClusterAlg::execute() {
...
StatusCode RawBankToFilteredSTLiteClusterAlg::decodeBanks(RawEvent* rawEvt,STLiteCluster::STLiteClusters* fCont) const{
...
StatusCode RawBankToFilteredSTLiteClusterAlg::finalize() {
